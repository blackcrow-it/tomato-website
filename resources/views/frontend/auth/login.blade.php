...
<style>
    .login-page {
        background-image: url('{{ asset("tomato/assets/img/image/login-1110x743.png") }}');
                                ...
                                <div class="tabJs">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade active show">
                                            ...
                                            <form class="form-input form-login" action="{{ route('login') }}"
                                                  method="POST">
                                                @csrf
                                                ...
                                                <div class="input-item">
                                                    ...
                                                    <label class="checkbox-item">
                                                        <a href="{{ route('forgot') }}" class="text-primary">Quên mật
                                                            khẩu ?</a>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="login-social">
                                                    ...
                                                    <div class="login-social__btn">
                                                        <a href="{{ route('auth.facebook') }}" class="login-facebook"><i
                                                                class="fa fa-facebook"></i> Facebook</a>
                                                        <a href="{{ route('auth.google') }}" class="login-google"><i
                                                ...
                                                <div class="login-social">
                                                    <span>hoặc</span>
                                                    <div class="login-social__btn">
                                                        <a href="{{ route('register') }}" class="register"><i
                                                                class="fa fa-sign-in"></i> Tạo tài khoản</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
