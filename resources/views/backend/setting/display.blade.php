...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label>Ảnh nền đăng ký nhận tin (832x1013)</label>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label>Ảnh nền trang đăng nhập (1110x743)</label>
            <div class="input-group">
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label>Ảnh nền trang đăng ký (1110x846)</label>
            <div class="input-group">
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label>Ảnh nền trang quên mật khẩu (1110x637)</label>
            <div class="input-group">
